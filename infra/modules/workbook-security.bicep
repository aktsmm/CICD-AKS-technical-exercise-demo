...
let categoryClean = replace_string(replace_string(replace_string(replace_string(categoryRaw, "\"", ""), "[", ""), "]", ""), " ", "");
let categories = iif(
  isempty(categoryClean),
...
let severityClean = replace_string(replace_string(replace_string(replace_string(severityRaw, "\"", ""), "[", ""), "]", ""), " ", "");
let severities = iif(
  isempty(severityClean),
